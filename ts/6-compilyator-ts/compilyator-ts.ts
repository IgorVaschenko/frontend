/* Projects */
// "incremental": true,                              /* Сохраняйте файлы .tsbuildinfo, чтобы разрешить добавочную компиляцию проектов. */
...
// "target": "ES2016",                               /* Установите версию языка JavaScript для создаваемого JavaScript и включите объявления совместимых библиотек. */
...
// "jsxFactory": "",                                 /* Укажите фабричную функцию JSX, используемую при нацеливании на генерацию React JSX, например. «React.createElement» или «h». */
...
/* Modules */
// "module": "commonjs",                            /* Указываем, какой код модуля генерируется. */
...
// "outDir": "./build/",                            /* Укажите выходную папку для всех созданных файлов. */
